...
* - ori_vue
* - des_vue
* - dia_vue (formato YYYY/MM/DD)
* - nda_vue (int pero lo pide en forma de String)
*
* Para realizar una consulta, usa ConsultaBD, con los métodos ConsultarCodVuelos, ConsultarVuelo y ConsultarVuelo todos
*
*/
